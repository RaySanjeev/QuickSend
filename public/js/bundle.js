...
},{}],"sendText.js":[function(require,module,exports) {
"use strict";
...
var sendText = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(userID, otp) {
    var res;
...
// DOM ELEMENTS
var sendMessageBtn = document.querySelector('.send__text');
var contactListBtn = document.querySelector('.sidebar__btn--1');
var messagesSentBtn = document.querySelector('.sidebar__btn--2');
var contactList = document.querySelector('.overview__content--contacts');
var messagesList = document.querySelector('.overview__content--messages'); // DELEGATIONS
...
var btnFunctions = function btnFunctions() {
...
if (contactListBtn) {
  contactListBtn.addEventListener('click', function (e) {
    e.preventDefault(); // contactList.classList.toggle('hidden');
    // messagesList.classList.toggle('hidden');
    // contactListBtn.classList.toggle('active');
    // messagesSentBtn.classList.toggle('active');
...
if (messagesSentBtn) {
  messagesSentBtn.addEventListener('click', function (e) {
    e.preventDefault(); // contactList.classList.toggle('hidden');
    // messagesList.classList.toggle('hidden');
    // contactListBtn.classList.toggle('active');
    // messagesSentBtn.classList.toggle('active');
